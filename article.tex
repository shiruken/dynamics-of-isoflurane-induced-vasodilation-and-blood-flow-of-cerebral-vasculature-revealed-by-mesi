...
All statistical analyses were also performed using MATLAB. Paired sample t-tests were used to compare awake and anesthetized measurements across vessel diameter and CBF metrics. The differences between arterial, venous, and parenchymal measurements were evaluated with one-way ANOVAs using the Bonferroni method for multiple comparisons. The significance level ($\alpha$) was set to 0.05 for all statistical tests.
...
The differences between awake and anesthetized measurements across vessel diameter and CBF metrics are summarized in Table \ref{tab:awakeanes}. Paired samples t-tests were performed on data aggregated across all subjects and imaging sessions in each state. Paired measurements from 33 arteries, 29 veins, and 46 parenchyma regions were included in the analysis. There were significant differences between the awake and anesthetized measurements for all tested metrics.

% Table 1 - Aggregated Awake vs. Anesthetized Summary
\begin{table}[]
    \caption {
        Paired samples t-tests comparing differences between awake and anesthetized measurements of aggregated vessel diameter and blood flow metrics ($\alpha = 0.05$).
    }
    \label{tab:awakeanes}
    \centering
    \begin{tabular}{llccc} 
