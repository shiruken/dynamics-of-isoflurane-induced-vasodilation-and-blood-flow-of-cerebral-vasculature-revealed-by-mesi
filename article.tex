...
The large anatomical changes caused by isoflurane are depicted with wide-field imagery and video highlighting the induction of anesthesia. Compared to the awake state, we measured, on average, a 14.1\% increase in surface vessel diameter accompanied by a 96.0\% increase in vascular flux and 84.7\% increase in parenchyma tissue perfusion. We also examined the dynamics of anesthesia induction and found that blood flow increased faster in arterioles than in venules or parenchyma regions.

\abstractsection{Comparison with Existing Methods}
MESI offers robust hemodynamic measurements across large fields-of-view and high temporal resolutions sufficient for continuous visualization of cerebrovascular events.
